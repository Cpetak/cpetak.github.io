...
![Distributions](modifier_ims/distrs.png)

However, now that I think about it, this is not how Dan drew the fitness distribution in Fig 2. In his case, 50% of the mutations are beneficial, but most beneficial mutations have small effect. Instead, the 50% that is disadvantageous have a high effect size. Hence, the average in negative. See below. Orange horizontal line: range of phenotypes randomly drawn for high noise modifier, blue horizontal line: range of phenotypes randomly drawn for low noise modifier. Right column: The distribution of fitnesses that correspond to those phenotypes.

![Dans distributions](modifier_ims/dd4.png)

Below are some visualisations to illustrate some of the points above. Developmental modifier, Blue high noise modifier, orange low noise modifier, triangle selected for reproduction. Density plot on the right: distribution of phenotypes for each of the modifier alleles. Blue is wider but the mean is the same, as in this run prob of negative and positive mutation were the same. note no change in average phenotype over time. y axis: phenotype, x axis: index of the individual in the population, ignore.

![Gen 0](modifier_ims/dev_0.png) ![Gen 1](modifier_ims/dev_1.png) ![Gen 2](modifier_ims/dev_2.png)
...
![Gen 0](modifier_ims/rep_0.png) ![Gen 1](modifier_ims/rep_1.png) ![Gen 2](modifier_ims/rep_2.png)
...
![Sel pres 2](modifier_ims/sel_2.png) ![Sel pres 10](modifier_ims/sel_10.png) ![Sel pres 20](modifier_ims/sel_20.png)
...
Recombination rate (high recombination rate with inheritance is worse than no inheritance)

new way of modeling the mutational bias (50-50 good and bad mutations but bad mutations have a bigger fitness effect, should not affect the results)
